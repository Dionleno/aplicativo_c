...
import { AppRegistry, View, Image, FlatList, StyleSheet, AsyncStorage, Alert ,ScrollView,ImageBackground} from 'react-native';
...
export class ProdutoDetalhes extends Component {
  ...
  componentDidMount = async() =>{
     await this.props.initDetails(this.props.navigation.state.params)
  }
                 ...
                 <Grid style={{marginHorizontal:15}}>
                 	...
                 	<Row style={{flex:1,marginBottom:15}}>
                 			...
                 			<ScrollView directionalLockEnabled={false}
							            horizontal={true} style={{flex:1,height:180}} >
